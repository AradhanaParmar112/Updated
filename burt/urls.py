...
urlpatterns = [
    ...
    path('new_query_boss/<int:number_of_tables>/<int:number_of_rows>/<int:number_of_columns>/<int:previous_data_pk>', views.new_query_boss, name='new_query_boss'),
    path('q_test', views.q_test, name='q_test')
]